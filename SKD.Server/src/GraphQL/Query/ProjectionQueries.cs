...
public class ProjectionQuery {
    ...
    [UseFiltering]
    [UseSorting]
    public IQueryable<KitStatusEvent> GetKitStatusEvents(SkdContext context) => context.KitStatusEvents.AsQueryable();

    [UsePaging(MaxPageSize = 10000)]
    [UseProjection]
    [UseFiltering]
    [UseSorting]
    public IQueryable<KitStatusEventType> GetKitTimelineEventTypes(SkdContext context) => context.KitStatusEventTypes.AsQueryable();
