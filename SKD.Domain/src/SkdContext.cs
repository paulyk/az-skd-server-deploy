...
public class SkdContext : DbContext {
    ...
    public DbSet<KitStatusEvent> KitStatusEvents => Set<KitStatusEvent>();
    public DbSet<KitStatusEventType> KitStatusEventTypes => Set<KitStatusEventType>();
    ...
    public SkdContext(DbContextOptions<SkdContext> options) : base(options) { }
