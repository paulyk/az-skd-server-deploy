...
namespace SKD.Domain.src.Migrations
{
    ...
    [Migration("20230530125044_VerifyVinToBuildStart")]
    partial class VerifyVinToBuildStart
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SKD.Model.ComponentStation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36)
            ...
            modelBuilder.Entity("SKD.Model.KitTimelineEventType", b =>
                {
                    ...
                    b.Property<string>("KitStatusCode")
                        .IsRequired()
                        .HasMaxLength(30)
                        .HasColumnType("nvarchar(30)");
            ...
            modelBuilder.Entity("SKD.Model.PCV", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36)
            ...
            modelBuilder.Entity("SKD.Model.PcvComponent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36)
            ...
            modelBuilder.Entity("SKD.Model.PcvDrive", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36)
            ...
            modelBuilder.Entity("SKD.Model.PcvEngine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36)
            ...
            modelBuilder.Entity("SKD.Model.PcvModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36)
            ...
            modelBuilder.Entity("SKD.Model.PcvPaint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36)
            ...
            modelBuilder.Entity("SKD.Model.PcvSeries", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36)
            ...
            modelBuilder.Entity("SKD.Model.PcvSubmodel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36)
            ...
            modelBuilder.Entity("SKD.Model.PcvTransmission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36)
            ...
            modelBuilder.Entity("SKD.Model.PcvTrim", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36)
            ...
            modelBuilder.Entity("SKD.Model.ComponentStation", b =>
                {
                    ...
                    b.HasOne("SKD.Model.ProductionStation", "Station")
                        .WithMany()
            ...
            modelBuilder.Entity("SKD.Model.PCV", b =>
                {
                    b.HasOne("SKD.Model.PcvDrive", "PcvDrive")
                        .WithMany("Pcvs")
                        .HasForeignKey("PcvDriveId");

                    b.HasOne("SKD.Model.PcvEngine", "PcvEngine")
                        .WithMany("Pcvs")
                        .HasForeignKey("PcvEngineId");

                    b.HasOne("SKD.Model.PcvModel", "PcvModel")
                        .WithMany("Pcvs")
                        .HasForeignKey("PcvModelId");

                    b.HasOne("SKD.Model.PcvPaint", "PcvPaint")
                        .WithMany("Pcvs")
                        .HasForeignKey("PcvPaintId");

                    b.HasOne("SKD.Model.PcvSeries", "PcvSeries")
                        .WithMany("Pcvs")
                        .HasForeignKey("PcvSeriesId");

                    b.HasOne("SKD.Model.PcvSubmodel", "PcvSubmodel")
                        .WithMany("Pcvs")
                        .HasForeignKey("PcvSubmodelId");

                    b.HasOne("SKD.Model.PcvTransmission", "PcvTransmission")
                        .WithMany("Pcvs")
                        .HasForeignKey("PcvTransmissionId");

                    b.HasOne("SKD.Model.PcvTrim", "PcvTrim")
                        .WithMany("Pcvs")
