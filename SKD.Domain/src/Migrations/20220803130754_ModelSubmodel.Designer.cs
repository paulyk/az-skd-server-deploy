...
namespace SKD.Domain.src.Migrations
{
    ...
    [Migration("20220803130754_ModelSubmodel")]
    partial class ModelSubmodel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SKD.Model.PcvSubmodelComponent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36)
                    ...
                    b.ToTable("pcv_submodel_component", (string)null);
                });
            ...
            modelBuilder.Entity("SKD.Model.PCV", b =>
                {
                    b.HasOne("SKD.Model.PcvSubmodel", "SubModel")
                        .WithMany("Pcvs")
            ...
            modelBuilder.Entity("SKD.Model.PcvSubmodel", b =>
                {
                    b.HasOne("SKD.Model.PcvModel", "Model")
                        .WithMany("Submodels")
                        .HasForeignKey("ModelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SKD.Model.Component", b =>
                {
                    ...
                    b.Navigation("SubmodelComponents");
                });
