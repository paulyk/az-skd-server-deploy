...
public static class EntityFieldLen {
    ...
    public readonly static int Pcv_Description = 500;
    ...
    public readonly static int Category_Code = 150;
    public readonly static int Category_Name = 150;

    public readonly static int Filename = 255;
}
