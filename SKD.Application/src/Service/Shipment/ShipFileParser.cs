...
public class ShipFileParser: IAppService {
    ...
    public static (string plantCode, int sequence, DateTime dateCreated) ParseHeaderLine(string line) {
    ...
    public static ShipFileLot ParseLotLine(string line) {
    ...
    public static ShipFileInvoice ParseInvoiceLine(string line) {
    ...
    public static ShipFilePart ParsePartLine(string line) {
        return new ShipFilePart {
            PartNo = PartService.ReFormatPartNo(partLineParser.GetFieldValue(line, t => t.NO_PART)),
